...
describe('DELETE /todos/:id', () => {
    ...
    it('should not remove a todo from an another user', (done) => {
...
describe('PATCH /todos/:id', () => {
    ...
    it('should not update the todo from a other user', (done) => {
        let hexId = todos[0]._id.toHexString();
        let text = 'should be the new text';
...
describe('POST /users', () => {
    ...
    it('should return validation errors it request invalid', (done) => {
        request(app)
            .post('/users')
            .send({
                email: 'and',
